...
export default function FourSeasonsSharmPage() {
  ...
  // Images (same structure as Madinaty)
  const HERO = "/project/four-seasons-sharm/fss-heroimage.jpg"
  const MAIN = "/project/four-seasons-sharm/fss-masterplan.jpg"
  const GALLERY = [
    "/project/four-seasons-sharm/fss-image1.jpg",
    "/project/four-seasons-sharm/fss-image2.jpg",
    "/project/four-seasons-sharm/fss-image3.jpg",
    // add more: fss-image4.jpg, fss-image5.jpg, ...
  ]
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              A comprehensive hospitality development focused on refined guest experience, landscape integration, and seamless access to the Red Sea waterfront.
            </p>
          </div>
          <ProjectStats />
        </div>
          ...
          <div className="mt-8 max-w-4xl">
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-600 leading-relaxed">
                A curated selection showing site structure, guest circulation, and the relationship between architecture,
                landscape, and sea views.
              </p>
            </div>
          </div>
        </div>
